...
* Update `org.apache.logging.log4j:log4j-bom` to version `2.22.0` (https://github.com/apache/logging-log4j-transform/pull/71[71])
* Update `org.apache.logging:logging-parent` to version `10.4.0` (https://github.com/apache/logging-log4j-transform/pull/66[66])

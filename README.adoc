...
https://github.com/apache/logging-log4j-transform/actions[image:https://github.com/apache/logging-log4j-transform/actions/workflows/build.yaml/badge.svg[Actions Status]]

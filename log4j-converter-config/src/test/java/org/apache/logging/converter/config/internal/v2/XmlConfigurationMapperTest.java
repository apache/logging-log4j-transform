...
class XmlConfigurationMapperTest extends AbstractConfigurationMapperTest {

    @Test
    void convertFromXml() throws IOException {
        ConfigurationParser parser = new XmlConfigurationMapper();
        try (InputStream inputStream = getClass().getResourceAsStream("/v2/log4j2.xml")) {
    ...
    @Test
    void convertToXmlAndBack() throws IOException {
        ConfigurationMapper mapper = new XmlConfigurationMapper();

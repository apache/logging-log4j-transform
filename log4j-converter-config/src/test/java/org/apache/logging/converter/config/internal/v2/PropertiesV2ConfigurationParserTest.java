...
class PropertiesV2ConfigurationParserTest extends AbstractConfigurationMapperTest {

    @Test
    void convertFromProperties() throws IOException {
        ConfigurationParser parser = new PropertiesV2ConfigurationParser();
        try (InputStream inputStream = getClass().getResourceAsStream("/v2/log4j2.properties")) {

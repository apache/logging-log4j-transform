...
/**
 * Parses a
 * <a href="https://logging.apache.org/log4j/1.x/apidocs/org/apache/log4j/SimpleLayout.html">SimpleLayout</a>
 * configuration.
 */
@ServiceProvider(Log4j1ComponentParser.class)
public class SimpleLayoutParser extends AbstractComponentParser<SimpleLayoutParser.SimpleLayoutBuilder> {

    @Override
    public String getClassName() {
        return "org.apache.log4j.SimpleLayout";
    }

    @Override
    protected SimpleLayoutBuilder createBuilder(Element element) {
        return new SimpleLayoutBuilder();
    }

    @Override
    protected SimpleLayoutBuilder createBuilder(PropertiesSubset properties) {
        return new SimpleLayoutBuilder();
    }
    ...
    public static class SimpleLayoutBuilder implements Supplier<ConfigurationNode> {
